...
/**
 * @Author: slilio @CreateTime: 2025-07-02 @Description: @Version: 1.0
 */
@Configuration
public class ChatClientConfig {
  ...
  public ChatClient chatClient(
      DeepSeekChatModel chatModel) { // （依赖注入 starter 自动装配的 DeepSeekChatModel 实例，它是 ChatModel
    // 接口的具体实现类）底层对接Deepseek大模型
