...
import com.slilio.ai.robot.model.ActorFilmography;
import com.slilio.ai.robot.model.Book;
...
public class StructuredOutputController {
  ...
  public Book getBookInfo(@RequestParam(value = "name") String bookTitle) {
    ...
    Prompt prompt =
        promptTemplate.create(Map.of("bookTitle", bookTitle, "format", converter.getFormat()));
